...
export default function ColectaCumpleanosAdultos() {
  const features = [
    {
      icon: <Cake className="w-6 h-6" />,
      title: "Cumpleaños Inolvidables",
      description: "Organiza regalos especiales para cumpleaños de amigos, familiares o compañeros de trabajo. Haz que sea una fecha memorable."
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Unifica a Todo el Grupo",
    ...
    },
    {
      ...
      description: "Haz que cada cumpleaños sea especial con regalos que realmente marquen la diferencia y demuestren cariño."
    }
  ];

  const benefits = [
    "Organiza regalos para cualquier cumpleaños de adulto",
    "Invita a amigos, familiares y compañeros de trabajo",
  ...
  const testimonials = [
    {
      name: "Martín R.",
      role: "Cumpleañero",
      content: "Para mis 30 años mis amigos organizaron una colecta increíble. Me regalaron algo que jamás me hubiera comprado solo. Fue muy emotivo.",
      rating: 5
    },
    {
      name: "Paula G.",
      role: "Amiga organizadora",
      content: "Con RegaloYa organizamos el cumple de 40 de nuestra amiga. Participaron compañeras del trabajo de hace años que viven lejos.",
      rating: 5
    },
    {
      name: "Diego M.",
      role: "Hermano",
      content: "Mi hermana cumplía 25 y quisimos hacerle algo especial. RegaloYa nos ayudó a organizarnos perfecto entre primos y amigos.",
      rating: 5
    }
  ];
  ...
  const faqs = [
    {
      question: "¿Cómo funciona para cumpleaños de adultos?",
      answer: "Creás un proyecto para el cumpleaños, invitás a amigos, familiares y compañeros, y todos pueden contribuir de forma segura para el regalo."
    },
    {
    ...
    },
    {
      ...
      answer: "Cualquier cosa: experiencias, viajes, electrodomésticos, hobbies, cursos, deportes, tecnología, decoración, etc."
    },
    {
      question: "¿Cómo invito a todos los amigos?",
      answer: "RegaloYa genera un enlace que podés compartir por WhatsApp, redes sociales o grupos de amigos. Cada uno hace clic y puede contribuir."
    },
    {
      question: "¿Puedo usarlo para cumpleaños en el trabajo?",
      answer: "Completamente apropiado. RegaloYa es perfecto para organizar regalos entre compañeros de trabajo de forma profesional."
    }
  ];
  ...
  return (
    <>
      <MetaTags
        title="Colecta para Regalo de Cumpleaños de Adultos | Sin Complicaciones"
        description="Organizá colectas para regalos de cumpleaños de amigos, familiares o colegas. Simple, seguro y 100% online."
        url="/colecta-cumpleanos-adultos"
      />
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50">
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-6xl text-center">
            <Badge variant="secondary" className="mb-6 bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 border-0">
              🎉 Solución para Cumpleaños de Adultos
            </Badge>
            
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
              Cumpleaños de Adultos
              <br />
              <span className="text-gray-800">Que Quedan en el Recuerdo</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              Organiza regalos grupales para cumpleaños de amigos, familiares o colegas de forma simple. 
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800">
                ¿Por qué elegir RegaloYa para cumpleaños de adultos?
              </h2>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800">
                Cómo Funciona RegaloYa para Cumpleaños de Adultos
              </h2>
              <p className="text-xl text-gray-600">
                En solo 3 pasos simples organizas el cumpleaños perfecto
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-12">
              <div className="text-center group">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-800">
                  Crea el Proyecto del Cumpleaños
                </h3>
                <p className="text-gray-600 leading-relaxed">
                  Define qué regalo quieren juntar para el cumpleañero y personaliza los detalles de la celebración.
                </p>
              </div>
              ...
              <div className="text-center group">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Comparte el enlace con amigos del colegio, facultad, trabajo y familia. Pueden participar desde cualquier lugar.
                </p>
              </div>
              ...
              <div className="text-center group">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Recibe las contribuciones y haz realidad el regalo que hará inolvidable este cumpleaños.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Beneficios Clave de RegaloYa para Cumpleaños de Adultos
              </h2>
              <p className="text-xl text-gray-600">
                Todo lo que necesitas para crear cumpleaños inolvidables
              </p>
            </div>
        ...
        <section className="py-20 px-4 bg-gradient-to-br from-gray-50 to-purple-50">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Lo Que Dicen Otros Cumpleañeros
              </h2>
              <p className="text-xl text-gray-600">
                Amigos reales que ya organizaron cumpleaños especiales con RegaloYa
              </p>
            </div>
        ...
        <section className="py-20 px-4 bg-white">
          <div className="container mx-auto max-w-4xl">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Preguntas Frecuentes sobre Cumpleaños de Adultos
              </h2>
              <p className="text-xl text-gray-600">
                Resolvemos todas tus dudas sobre regalos de cumpleaños
              </p>
            </div>
        ...
        <section className="py-20 px-4 bg-gradient-to-br from-purple-50 to-pink-50">
          <div className="container mx-auto max-w-4xl text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-800">
              Empezá Ahora y Crea Cumpleaños Inolvidables
            </h2>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Sumate a los amigos que ya organizan cumpleaños especiales de forma simple y colaborativa.
            </p>
            
            <Link href="/auth">
              <Button size="lg" className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white border-0 shadow-lg px-8 py-4 text-lg">
                🎂 Crear Mi Regalo de Cumpleaños Gratis
                <Cake className="ml-2 w-5 h-5" />
              </Button>
            </Link>
